...
function generateSearchResult(result) {
  ...
  centerDiv.className = 'center align-center';
...
function generateReview(dataObj) {
  ...
  userGenre.className = 'genre section align-center';
  ...
  userRuntime.className = 'runtime section align-center';
  ...
  userActor.className = 'actors section align-center';
